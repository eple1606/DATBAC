...
def get_device_name(device_signature):
    ...
    # Set threshold based on whether the SSID is hidden or not
    required_matches = 3 if not is_hidden_ssid else 2
    ...
    for existing_signature, existing_device_name in device_signatures.items():
        ...
        # Check SSID and Features (HT, EXT, Vendor) for matching
